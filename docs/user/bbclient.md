...
Installation documentation is available [Geniml installation](/geniml/).
...
!!! info 
    Full usage documentation is available [BBclient usage](/geniml/bbclient/bbclient/).
...
How to install and use RegionSet in Python is described in the [RegionSet documentation](/gtars/regionset/). 
