...
- [Create consensus peaks with CLI](/geniml/tutorials/create-consensus-peaks/)
- [Create consensus peaks with Python](/geniml/notebooks/create-consensus-peaks-python/)

### 2. Evaluating a universe

The main methods are implemented in the `assess-universe` model with tutorial:

- [Assess universe fit tutorial](/geniml/tutorials/assess-universe/)